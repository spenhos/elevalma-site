...
{% include blog-img.html src="/images/blog/saltamontes-1-espias.png" alt="Dos exploradores cargando un racimo de uvas gigante por el desierto al atardecer" %}
...
{% include blog-img.html src="/images/blog/saltamontes-2-valle.png" alt="Valle con ciudades amuralladas visto desde lo alto de la montaña" %}
...
{% include blog-img.html src="/images/blog/saltamontes-3-jevron.png" alt="Figura solitaria en oración ante una cueva antigua en Jevrón" %}
...
Y aquí hay que decir algo incómodo: los diez probablemente creyeron que su pequeñez era humildad. Encogerse suena piadoso. Pero como vimos la semana pasada, [la humildad real no es pensar menos de ti — es no pensar en ti](https://elevalma.com/blog/anav-meod-humildad-moshe-behaalotja/). Moshé, el más humilde de todos los hombres, jamás dijo "no podemos". La humildad mira a Hashem; el complejo se mira a sí mismo. Los espías no eran humildes: estaban hipnotizados con su propio reflejo.

---

## La noche que todavía pagamos

{% include blog-img.html src="/images/blog/saltamontes-4-noche.png" alt="Campamento de tiendas bajo el cielo nocturno del desierto" %}
...
{% include blog-img.html src="/images/blog/saltamontes-hilo-tejelet.png" alt="Hilo de tejélet azul sobre fondo oscuro iluminado con luz dorada" %}
...
**Dos.** ¿Quién me dijo que soy pequeño? Busca la fuente. Casi siempre descubrirás que el "así me ven" es un "así me veo" proyectado. Nadie te midió. [Y retirarse de la pelea no siempre es crecer — a veces es solo huir](https://elevalma.com/blog/huir-crecer-espiritualmente-bemidbar-rut/).
...
Este artículo es parte de la serie semanal de [Perashá de ElevAlma](https://elevalma.com/blog/). Si quieres profundizar en los temas conectados, te invito a leer:

- [ANAV MEOD — La humildad no es pensar menos de ti, es no pensar en ti](https://elevalma.com/blog/anav-meod-humildad-moshe-behaalotja/) — la parashá anterior, Beha'alotjá: la diferencia exacta entre humildad y complejo
- [HUIR — ¿Cuándo "crecer espiritualmente" es HUIR?](https://elevalma.com/blog/huir-crecer-espiritualmente-bemidbar-rut/) — sobre la frontera entre retirarse y rendirse
- [LA TRIPLE AVODÁ — Cuando servir se vuelve canto](https://elevalma.com/blog/triple-avoda-cuando-servir-se-vuelve-canto-naso/) — Nasó: las capas invisibles del servicio
- [EN TI — Dios no está donde tú crees](https://elevalma.com/blog/en-ti-dios-no-esta-donde-crees-teruma/) — sobre construir el espacio interior donde habita la Presencia

¿Tienes una pregunta sobre este tema o quieres explorar alguna de estas fuentes en profundidad? [Escríbeme directamente](https://elevalma.com/consultas/) — las consultas por email son gratuitas.
